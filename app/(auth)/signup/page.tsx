  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mb-7">
        <h1 className="text-2xl font-bold text-[#0a0a0a] tracking-tight">Sign up for SourceIQ</h1>
        <p className="mt-2 text-sm text-[#0a0a0a]/50">
          Already have an account?{" "}
          <Link href={loginHref} className="text-[#0a0a0a] font-medium hover:text-[#0a0a0a]/70 transition-colors">
            Log in
          </Link>
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-xs font-medium text-[#0a0a0a]/60 mb-1.5">Password</label>
