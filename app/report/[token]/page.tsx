      ...
      <div className="flex items-center gap-2 mb-2">
        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
          <path
            ...
            stroke="#c4c4c4" strokeWidth="1.2" strokeLinecap="round"
          />
        </svg>
...
export default async function ReportPage({
  ...
  // Fetch live GHL data using the same shared function as the dashboard sync route.
  // Data refreshes on every page view — no caching needed until scale requires it.
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-lg mx-auto px-5 py-8 pb-16">
        ...
        {/* AI Summary — placeholder until Anthropic API is wired */}
        <div className="mb-8">
